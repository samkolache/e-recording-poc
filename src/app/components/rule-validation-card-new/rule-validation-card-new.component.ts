...
@Component({
  selector: 'app-rule-validation-card-new',
  standalone: true,
  imports: [CommonModule],
  templateUrl: './rule-validation-card-new.component.html',
  styleUrls: ['./rule-validation-card-new.component.scss']
})
export class RuleValidationCardNewComponent {
